...
<body data-spy="scroll" data-target="#navbar" class="static-layout">
    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center text-white" href="/">
            <h3 class="font-weight-bolder mb-0">DISEÑO GRAFICO</h3>
        </a>
...
<div id="side-nav" class="sidenav">
	...
	<div class="sidenav-content">
		<p>
			unitecnica, manizales, Colombia
		</p>
		<p>
			<span class="fs-16 primary-color">(+57) 3183979424</span>
		</p>
		<p>jc.torres@unitecnica.net</p>
	</div>
  ...
  <div class="container text-center">
    <h1 class="display-1 mb-4">DISEÑO<br>GRAFICO</h1>
  </div>
                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 offset-md-right-2 col-sm-6" data-aos="fade-left">
                            <h4 class="mb-4">Diseño Gráfico Digital</h4>
                            <p>Técnico Laboral en Diseño Gráfico Digital.</p>
                            <p>+ Diplomado en Marketing Digital.</p>
                            <p>+ 5 Certif. TI: Photoshop/Illustrator</p>
                            <p>InDesign/Premier/AfterEffects</p>
            ...
            <div class="row">
                ...
                <div class="testi-content testi-carousel owl-carousel">
                    <div class="testi-item text-center">
                        ...
                        <h4 class="testi-text"><b>DISEÑO GRAFICO</b> es una disciplina que combina arte, comunicación y tecnología para crear soluciones visuales que transmitan un mensaje de manera efectiva.<br> </h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            ...
                            <div class="testi-details">
                                <p class="testi-author mb-0 font-weight-bolder">Juan Camilo</p>
                                <p class="testi-desc mb-0">Torres Sanchez</p>
                            </div>
                        </div>
                    ...
                    <div class="testi-item text-center">
                        <i class="testi-icon fa fa-3x fa-quote-left"></i>
                        <h4 class="testi-text"> es el arte de comunicación visual a través de texto, imágenes, símbolos o ilustraciones <br> </h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/testi-1.jpg" alt="">
                            </div>
                     ...
                     <div class="testi-item text-center">
                        <i class="testi-icon fa fa-3x fa-quote-left"></i>
                        <h4 class="testi-text">La carrera de Diseño Gráfico consiste en aprender sobre la composición visual, estética y manejo de herramientas para transformar una idea en una pieza grafica. Un Diseñador Gráfico aplica el lenguaje visual para proporcionar propuestas visuales basadas en las necesidades del cliente <br> </h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="img/testi-1.jpg" alt="">
                            </div>
    ...
    <div class="container">
        <div class="section-content">
            ...
            <div class="title-wrap">
                <h2 class="section-title">Proyectos <b>HTML</b> Trabajos</h2>
                <p class="section-sub-title">Juan Camilo Torres Sanchez. <br> Unitecnica Tercer Semestre</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 portfolio-holder mt-3">
                    ...
                    <div class="filter-button-group btn-filter d-flex justify-content-center">
                        <a tabindex="0" class="is-checked" data-filter="*">Todos los Proyectos</a>
                        <a tabindex="0" data-filter=".minimalism">Minimalista</a>
                            ...
                            <div class="grid-item-wrapper">
                                ...
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        ...
                                        <a class="ext-link" href="csscolor.html" target="_blank">
                            ...
                            <div class="grid-item-wrapper">
                                ...
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        ...
                                        <a class="ext-link" href="TRABAJO HTML/index.html" target="_blank">
                                            <span class="lnr lnr-link"></span>
                                        </a>
                                    </div>
                                    <div class="grid-title">
                            ...
                            <div class="grid-item-wrapper">
                                ...
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        ...
                                        <a class="ext-link" href="camper cafe.html" target="_blank">
                                            <span class="lnr lnr-link"></span>
                                        </a>
                                    </div>
                                    <div class="grid-title">
                            ...
                            <div class="grid-item-wrapper">
                                ...
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        ...
                                        <a class="ext-link" href="https://unitecnica.net/" target="_blank">
                                            <span class="lnr lnr-link"></span>
                                        </a>
                                    </div>
                                    <div class="grid-title">
                            ...
                            <div class="grid-item-wrapper">
                                ...
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        ...
                                        <a class="ext-link" href="ben10.html" target="_blank">
                                            <span class="lnr lnr-link"></span>
                                        </a>
                                    </div>
                                    <div class="grid-title">
                            ...
                            <div class="grid-item-wrapper">
                                ...
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        ...
                                        <a class="ext-link" href="https://blog.hubspot.es/marketing/diseno-grafico/" target="_blank">
                                            <span class="lnr lnr-link"></span>
                                        </a>
                                    </div>
                                    <div class="grid-title">
            ...
            <div class="row ">
                <div class="col-md-12">
                    ...
                    <div class="title-wrap mb-5">
                        <h2>Tu Amas tu Trabajo  <span> ?</span> yo Si</h2>
                    </div>
                    <!-- End of Section Title -->
                </div>
                <!-- Client Holder -->
